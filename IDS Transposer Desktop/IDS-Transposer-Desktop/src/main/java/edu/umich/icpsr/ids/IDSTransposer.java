...
public class IDSTransposer {
	...
	public  IDSTransposer(Map<String, File> dataFiles, File entityMappingFile, String entityMappingFileRealFileName, File relationMappingFile, String relationMappingFileRealFileName, boolean isCommaSeparated) throws IDSException {
	...
	public void readRelationshipMapping() throws Exception {
		...
		try {
			...
			if (relationMappingList.isEmpty())
	...
	private ICsvMapReader getReader(String fileName) throws FileNotFoundException, Exception {
		...
		ICsvMapReader mapReader = new CsvMapReader(new FileReader(fileName), CSVPreference(isCommaSeparated));
	...
	private ICsvMapReader getReader(File file) throws FileNotFoundException, Exception {
		...
		ICsvMapReader mapReader = new CsvMapReader(new FileReader(file),  CSVPreference(isCommaSeparated));
	...
	private ICsvListWriter getWriter(String fileName) throws IOException {
		...
		ICsvListWriter listWriter = new CsvListWriter(new FileWriter(fileName),  CSVPreference(isCommaSeparated));
...
;
	...
	private boolean isBlank(String theString) {
		...
		if (theString == null)
			return true;
		else return theString.trim().equals("");
	}
	...
	private static CsvPreference  CSVPreference(boolean isCommaSeparated){
		if (isCommaSeparated){
